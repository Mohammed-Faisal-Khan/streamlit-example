...
if app_mode=='Prediction':
    ...
    if option=='Neural Network':
        ...
        if method_2 == 'Data Driven Forecasting Methods':
            ...
            conc = st.sidebar.radio('Forecasting Conclusion',('RMSE Values', 'Plot'))
            if conc == 'RMSE Values':
...
if app_mode=='Prediction':
    if option=='Neural Network':
        ...
        if method_1 == 'Bidirectional LSTM':
            st.subheader('Predicting the Price Using Bidirectional LSTM')
            #Model Building
...
if app_mode=='Prediction':
    if option=='Neural Network':
        ...
        if method_1 == 'GRU (Gated Recurrent Unit) LSTM':
            st.subheader('Predicting the Price Using GRU (Gated Recurrent Unit) LSTM')
            #Model Building
...
if app_mode=='Prediction':
    if option=='Neural Network':
        ...
        if method_1 == ' BGRU (Bidirectional GRU) LSTM':
            st.subheader('Predicting the Price Using  BGRU (Bidirectional GRU) LSTM')
            #Model Building
